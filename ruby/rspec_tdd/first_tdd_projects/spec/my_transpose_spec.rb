...
describe "#my_transpose" do
  ...
  # raise error if array to transpose is not square
  ...
  # raise error if array elements are not all integers
  ...
  # returns a two-dimensional array with transposed elements
